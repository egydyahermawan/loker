                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Lowongan / </span>Edit Lowongan</h4>
                                        ...
                                        <div class="card-body">
                                            <form action="/lowongan/update" method="POST" enctype="multipart/form-data"
                                                ...
                                                <div class="col mb-3">
                                                    ...
                                                    <textarea id="myeditorinstance" name="description">{{ old('description', $lowongan->description) }}</textarea>
                                                    {{-- <textarea class="form-control" id="description" rows="10" name="description">{{ old('description', $lowongan->description) }}</textarea> --}}
                                                    @error('description')
                                                        <span class="text-danger mt-1">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3">
                                                            ...
                                                            <input type="number" class="form-control" name="slot"
                                                                id="slot" value="{{ old('slot', $lowongan->slot) }}">
                                                            @error('slot')
                                                                <span class="text-danger mt-1">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="col-3">
                                                            ...
                                                            <input type="date" class="form-control" name="open"
                                                                id="open" value="{{ old('open', $lowongan->open) }}">
                                                            @error('open')
                                                                <span class="text-danger mt-1">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="col-3">
                                                            ...
                                                            <input type="date" class="form-control" name="closed"
                                                                id="closed"
                                                                value="{{ old('closed', $lowongan->closed) }}">
                                                            @error('closed')
                                                                <span class="text-danger mt-1">{{ $message }}</span>
                                                            @enderror
                                                        </div>
