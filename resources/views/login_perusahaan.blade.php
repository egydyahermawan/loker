...
@section('title', 'Login - Admin Perusahaan')
                ...
                <div class="authentication-inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form id="formAuthentication" class="mb-3" action="{{ route('login_perusahaan') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" id="password" class="form-control" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" value="{{ old('username') }}" />
